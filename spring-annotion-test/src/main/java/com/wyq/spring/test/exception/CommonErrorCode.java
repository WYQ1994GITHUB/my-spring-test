...
package com.wyq.spring.test.exception;
...
public enum CommonErrorCode {
    ...
    REQUEST_BIG_DATA_ERROR(520, "请求大数据查询录音地址错误"),
    RESTORE_TIME_OUT(521, "解冻录音超时"),
     ...
     * 任务相关异常码
     */
    AI_JOB_HAS_SUB_TASK_RUNNING(440, "当前AI外呼任务至少还有一个子任务在运行，无法启动"),
    ...
    COMPANY_HAS_BIND_ISV(10003, "公司已绑定isv"),
    AGENCY_HAS_BIND_ISV(10004, "集成商已绑定isv"),
    AGENCY_NOT_AK_PERMISSION(10005, "集成商未开启AK配置"),
    ...
    NOT_SUPPORT_SWITCH(40000005, "当前版本不支持切换"),

    /**
     * scrm暂不支持app登录
     */
    SCRM_NOT_PERMIT_LOGIN_APP(80000001, "当前版本暂不支持APP登录功能"),
    ...
    // 萤火保需求定制code
    INSURE_SUCCESS(1, "投保信息接收成功"),
    INSURE_ERROR_AUTH(0, "身份验证失败"),
    INSURE_ERROR(-1, "系统异常"),
    ...
    public static CommonErrorCode fromCode(Integer code) {
        CommonErrorCode[] enums = CommonErrorCode.values();
        for (CommonErrorCode errorCode : enums) {
